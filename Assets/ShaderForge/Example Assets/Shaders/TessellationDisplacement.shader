        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                void displacement (inout VertexInput v){
                    float4 node_3490 = _Time + _TimeEditor;
                    float2 node_6 = (v.texcoord0*2.0);
                    float2 node_161 = (node_6+node_3490.g*float2(0.4,0));
                    float node_15 = 1.0;
...
/// Final Color:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                void displacement (inout VertexInput v){
                    float4 node_9414 = _Time + _TimeEditor;
                    float2 node_6 = (v.texcoord0*2.0);
                    float2 node_161 = (node_6+node_9414.g*float2(0.4,0));
                    float node_15 = 1.0;
                    float4 _DisplacementR_var = tex2Dlod(_DisplacementR,float4(TRANSFORM_TEX(node_161, _DisplacementR),0.0,node_15));
                    float4 node_803 = tex2Dlod(_AORGBHeightA,float4(TRANSFORM_TEX(node_6, _AORGBHeightA),0.0,node_15));
                    v.vertex.xyz += (v.normal*((1.0 - max(_DisplacementR_var.r,node_803.a))*((-1.0)*_Depth)));
...
/// Final Color:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                void displacement (inout VertexInput v){
                    float4 node_4802 = _Time + _TimeEditor;
                    float2 node_6 = (v.texcoord0*2.0);
                    float2 node_161 = (node_6+node_4802.g*float2(0.4,0));
                    float node_15 = 1.0;
                    float4 _DisplacementR_var = tex2Dlod(_DisplacementR,float4(TRANSFORM_TEX(node_161, _DisplacementR),0.0,node_15));
                    float4 node_803 = tex2Dlod(_AORGBHeightA,float4(TRANSFORM_TEX(node_6, _AORGBHeightA),0.0,node_15));
                    v.vertex.xyz += (v.normal*((1.0 - max(_DisplacementR_var.r,node_803.a))*((-1.0)*_Depth)));
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                void displacement (inout VertexInput v){
                    float4 node_8777 = _Time + _TimeEditor;
                    float2 node_6 = (v.texcoord0*2.0);
                    float2 node_161 = (node_6+node_8777.g*float2(0.4,0));
                    float node_15 = 1.0;
                    float4 _DisplacementR_var = tex2Dlod(_DisplacementR,float4(TRANSFORM_TEX(node_161, _DisplacementR),0.0,node_15));
                    float4 node_803 = tex2Dlod(_AORGBHeightA,float4(TRANSFORM_TEX(node_6, _AORGBHeightA),0.0,node_15));
                    v.vertex.xyz += (v.normal*((1.0 - max(_DisplacementR_var.r,node_803.a))*((-1.0)*_Depth)));
